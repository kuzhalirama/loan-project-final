...
// //     this.http
// //       .get(
// //         `http://localhost:7092/api/emiplans/${this.paymentDetails.customerId}/${this.paymentDetails.loanPlanId}`
// //       )
// //       .subscribe(
// //         (response: any) => {
...
// //     this.http
// //       .get(
// //         `http://localhost:7092/api/emiplans/${this.paymentDetails.customerId}/${this.paymentDetails.loanPlanId}/paymenthistory`
// //       )
// //       .subscribe(
// //         (response: any) => {
...
// //   payEMI() {
// //     this.checkEMIStatus(); // Ensure the latest status is checked before payment
...
// //           this.checkEMIStatus(); // Refresh EMI status after payment
// //           this.fetchPaymentHistory(); // Refresh payment history after payment
// //         },
// //         (error: any) => {
    ...
    this.emiPaymentService
      ...
      .subscribe(
        ...
        (error: any) => {
          ...
          // this.acknowledgement = `Failed to process EMI payment.${error.message}`;
        }
      );
  }
